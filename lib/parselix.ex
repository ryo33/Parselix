defmodule Parselix do
  ...
  @typedoc "A successful result of product parser."
  @type ok :: {:ok, any, String.t, %Position{}}
  @typedoc "A failed result of product parser."
  @type error :: {:error, String.t, %Position{}}
  @typedoc "A successful result of source parser."
  @type ok_1 :: {:ok, any, integer}
  @typedoc "A successful result of source parser."
  @type ok_2 :: {:ok, any, String.t}
  @typedoc "A failed result of source parser."
  @type error_1 :: {:error, String.t}
  @typedoc "A parser generated by parser/2."
  @type product_parser :: (String.t, %Position{} -> ok | error)
  @typedoc "A parser passed to parser/2."
  @type source_parser :: (product_parser, any, String.t, %Position{} -> ok | ok_1 | ok_2 | error | error_1)
  ...
  @spec parser(String.t, source_parser) :: product_parser
  @doc """
  ...
  defmacro parser(name, do: block) do
    ...
    quote do
      ...
      @doc """
      This is almost the same function as #{unquote(name)}/1, but it returns a result with metadata.
      """
